...
def load_cloud_api_settings() -> CloudApiSettings:
    ...
    supabase_secret_key = _env_value("SUPABASE_SECRET_KEY")
    supabase_service_role_key = _env_value("SUPABASE_SERVICE_ROLE_KEY")
    api_token = _env_value("NJORDHR_API_TOKEN") or _env_value("NJORDHR_ADMIN_TOKEN")
    return CloudApiSettings(
        service_name="njordhr-cloud-api",
        auth_mode=_env_value("NJORDHR_AUTH_MODE") or "cloud",
