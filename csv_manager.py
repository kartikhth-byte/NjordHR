...
class CSVManager:
    ...
    def log_ai_search_audit(
        ...
        new_row = {
            ...
            'Present_Rank_Filter': str(present_rank_filter or ''),
            ...
            'CoC_Issue_Authority_Filter': str(coc_issue_authority_filter or ''),
            'Availability_Filter': str(availability_filter or ''),
