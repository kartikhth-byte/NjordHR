#!/usr/bin/env python3
"""Evaluate the vessel-tonnage shadow-normalizer evidence corpus."""
...
DEFAULT_CORPUS = Path("docs/eval-evidence/vessel-tonnage-shadow-normalizer-corpus-2026-06-30.json")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate the vessel-tonnage shadow-normalizer evidence corpus.")
    parser.add_argument("--corpus", default=str(DEFAULT_CORPUS), help="Path to the vessel-tonnage evidence corpus JSON.")
